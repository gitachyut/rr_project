...
<form class="form-horizontal" action="<?= base_url() ?>/monkey/UpdateMonkey/" method="post">
<input type="hidden" name="csrf_token" value="<?= Csrf::csrf_token(); ?>">
<input type="hidden" name="id" value="<?= $this->profile['id'] ?>">
    <fieldset>
      <legend>Update Monkey</legend>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10">
            ...
            value="<?= _e($this->profile['username']) ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <textarea class="form-control" name="bio" rows="3" id="textArea"><?= _e($this->profile['bio']) ?></textarea>
          </div>
      </div>
      </div>
      <div class="col-lg-6">
