  ...
  <div class="jumbotron">
    ...
    <div class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane active" id="profile">
        <b><i>Email:</i></b><p><a href="mailto:<?= _e($this->profile['email']) ?>"><?= _e($this->profile['email']) ?></a></p>
      ...
      <div role="tabpanel" class="tab-pane" id="favfriend">Fav Friend</div>
      <div role="tabpanel" class="tab-pane" id="addfriends">Add Friend</div>
    </div>
